...
$sql = "INSERT INTO practise (Question,Answer1,Answer2,Answer3,Answer4,Correct,Subject_id,Subject) VALUES ('$Question','$Answer1','$Answer2','$Answer3','$Answer4','$Correct','$_SESSION[s_id]','$_SESSION[sub_name]')";
