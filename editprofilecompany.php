...
{
?>
<form name="f10" action="editpfcompany.php" method="post" enctype="multipart/form-data">
...
<label ><i class="material-icons">&#xe63d;</i>COMPANY Name:</label>&emsp;&emsp;&emsp;&emsp;<input type="text" name="m13"  value="<?php echo $row1['Cname']; ?>" required /><br><br>
<label><i class="material-icons">&#xe158;</i>COMPANY Email-ID:</label>&emsp;&emsp;&nbsp;<input type="email" name="m14" value="<?php echo $row1['C_emailid']; ?>" required /><br><br>
<label><i class="material-icons">&#xe0cd;</i>COMPANY Address:</label>&emsp;&emsp;&nbsp;<input type="text" name="m15" value="<?php echo $row1['Caddress']; ?>" required /><br><br>
<label><i class="material-icons">&#xe0cd;</i>Contact-NO:</label>&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;<input type="text" name="m16" value="<?php echo $row1['Ccontact']; ?>" required /><br>
<br><br>
